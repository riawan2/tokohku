                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form " method="post">
                            ...
                            <button class="btn btn-primary " name="masuk">Login Now</button>
                            <hr />
                        ...
                        if (isset($_POST['masuk'])) {
                            ...
                            //melakukan pengecekkan akun di tabel pelanggan
                            $ambil =  $koneksi->query("SELECT * FROM pelanggan WHERE email='$email'
                          AND password ='$password'");
                            //ngitung akun yng diambil
                            ...
                            if ($akunyangcocok == 1) {
                                ...
                                //anda gagal login
                                echo "<script>alert('anda gagal login, periksa akun anda lagi);</script>";
